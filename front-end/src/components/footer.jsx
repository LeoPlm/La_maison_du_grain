        ...
        <Container>
            <div className='row'>
                ...
                <div className='col-6 d-flex flex-column text-dark'>
                    <h4 className='fw-bold'>Plus d'informations</h4>
                    <NavLink to="/contact" className='text-dark text-decoration-none'>Contactez-nous</NavLink>
                    <NavLink to="/quisommesnous" className='text-dark text-decoration-none'>A propos de nous</NavLink>
                    <NavLink to="#" className='text-dark text-decoration-none'>Mentions Légales</NavLink>
                </div>
